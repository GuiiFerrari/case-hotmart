    ...
    def fetch_info_from(url: str) -> list[dict[str, str]]:
        ...
        Returns:
            list[dict[str, str]]: List of dictionaries containing
                the title and text of the fetched content.
        """
        ...
        for h2 in soup.find_all("h2"):
            ...
            content.append({"title": h2.get_text(), "text": " ".join(text)})
        return content


if __name__ == "__main__":
    Fetcher.fetch_info_from("https://hotmart.com/pt-br/blog/como-funciona-hotmart")
